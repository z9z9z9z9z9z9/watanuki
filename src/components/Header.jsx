  ...
  return (
    <div className="relative bg-lightBg p-4">
      <div className="flex gap-2 md:gap-5 justify-between items-center">
        ...
        <div className="right md:w-11/12 flex gap-2 md:gap-5 items-center">
          <form
            action={`/search?keyword=${value}`}
            onSubmit={handleSubmit}
            className="search md:flex hidden relative  items-center w-full"
          >
            <input
              value={value}
              ...
              type="text"
              className="header-search w-full px-1 bg-[#FBF8EF]  text-black py-1 rounded-md"
            />
